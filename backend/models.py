from sqlalchemy import create_engine, Column, Integer, String, Text, Numeric, ForeignKey, DateTime, Date, Time, Boolean
...
class Worker(Base):
    ...
    courier_orders = relationship('Order', back_populates='courier')
...
class Order(Base):
    ...
    courier = relationship('Worker', back_populates='courier_orders')
